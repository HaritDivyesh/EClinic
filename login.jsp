...
<div class="page-header"><br>
    <h1 align=center>Interactive Login </h1>
</div>
    ...
    <div class="row colored">
        <div id="contentdiv" class="contcustom">
            ...
            <div>
				...
				<br><br>
				<center>
				<a href="doctor_registration.jsp"><button type="button" class="btn btn-primary btn-lg">Doctor Register Here</button></a>&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="operator_registration.jsp"><button type="button" class="btn btn-primary btn-lg">Operator Register Here</button></a>
				</center>
