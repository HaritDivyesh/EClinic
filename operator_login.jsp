...
<div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
               ...
               <div class="top-nav">
					<ul>
						<li><a href="admin_login.jsp"><i class="fa fa-sign-in"></i>&nbsp; Admin</a></li>
						<li><a href="doctor_login.jsp"><i class="fa fa-sign-in"></i>&nbsp; Doctor</a></li>
						<li class=active><a href=#><i class="fa fa-sign-in"></i>&nbsp; Operator</a></li>
					</ul>					
				</div>
            </div>
        </nav>
...
<div class="page-header"><br>
    <h1 align=center>Operator Login </h1>
</div>
